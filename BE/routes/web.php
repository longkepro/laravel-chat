...
// Route::post('/dashboard/message',[ChatController::class, 'messageReceived'])
//     ->middleware(['auth'])
//     ->name('messageReceived');

// Route::get('/dashboard/messages/{receiver}', [ChatController::class, 'getMessages'])->middleware(['auth'])->name('getMessages');
...
// Route::post('/select-user/{id}', [ChatController::class, 'selectUser'])
//     ->name('selectUser')
//     ->middleware('auth');

// Route::put('/update-last-readed-msg/{receiverId}',[ChatController::class, 'updateLastReadedMsg']) ->name('updateLastReadedMsg')->middleware('auth');

// Route::get('/unread-messages/{receiverId}', [ChatController::class, 'unreadMessages']) ->name('unreadMessages')->middleware('auth');
