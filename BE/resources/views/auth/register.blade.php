...
<body class="min-h-screen flex items-center justify-center bg-gray-100 font-sans">
  <div class="flex w-11/12 max-w-5xl h-[600px] bg-white rounded-lg shadow-lg overflow-hidden">
    ...
    <form method="POST" action="/register" class="w-1/2 p-10 flex flex-col justify-center items-center bg-white bg-opacity-90 space-y-4">
      ...
      <x-forms.form-title>Sign up</x-forms.form-title>

      <div class="w-4/5">
        <label for="username" class="block text-sm font-medium text-gray-700">
          <i class="fas fa-user mr-1"></i> Username:
        </label>
        <x-forms.form-input type="text" id="username" name="username" />
        <x-forms.form-error name="username" />
      </div>
      ...
      <div class="w-4/5 space-y-1">
        ...
        <x-forms.form-input type="email" id="email" name="email" />
      ...
      <div class="w-4/5 space-y-1">
        ...
        <x-forms.form-input type="password" id="password" name="password" />
      ...
      <div class="w-4/5 space-y-1">
        ...
        <x-forms.form-input type="password" id="password_confirmation" name="password_confirmation" />
        <x-forms.form-error name="password_confirmation" />
      </div>

      <x-forms.form-button class="mt-4 mb-2"> Sign up</x-forms.form-button>

      <div class="flex gap-4">
        <x-forms.social-auth-button url="{{ url('/login/google')}}" logo="logos/google-logo-png-google-icon-logo-png-transparent-svg-vector-bie-supply-14.png"></x-forms.social-auth-button>

        <x-forms.social-auth-button url="{{ url('/login/facebook')}}" logo="logos/Facebook_Logo_2023.png"></x-forms.social-auth-button>
      </div>
